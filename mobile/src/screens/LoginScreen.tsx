...
import { saveAuthToken } from '../api/authStorage';

type Role = 'patient' | 'caregiver';

// Swap this out for your real navigation type once react-navigation is wired up.
type Props = {
  onLoginSuccess: (role: Role, token: string, patientId: string | null) => void;
  onGoToRegister: () => void;
};
...
export default function LoginScreen({ onLoginSuccess, onGoToRegister }: Props) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      onLoginSuccess(result.role, result.token, result.patientId);
    } catch (e: any) {
